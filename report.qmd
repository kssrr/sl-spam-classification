...
![Potential competitors versus the deep neural network, evaluated on the training set. The 95% confidence intervals were calculated across the ten folds used for tuning.](figures/uncertainty_precision.png){width="80%"}
